...
<head>
  ...
  <meta charset="UTF-8">
    ...
    <title>OUTPATIENT BILL Form</title>
...
<!-- <script src="js/script.js"></script> -->
            ...
            <div class="container">
              <div class="row">
                  <div class="col-md-4"></div>
                    <div class="col-md-4">
                    <form name="" action = "outpatientbill.php" onsubmit = "" method = "POST">
                            ...
                            <input type = "text" id ="Docname" name  = "Docname" class="form-control"/><br />
    ...
    <!-- Add Bootstrap JS link here if needed (Optional) -->
</body>
</html>