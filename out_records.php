...
// $sqlselect = "SELECT * FROM OUTPATIENT where Hno='$Hno' ";
// $result = $connect->query($sqlselect);

// if ($result->num_rows > 0)
// {
//     echo "<h3>OUTPATIENT_DATA:</h3><br><br>";
